...
export const getUserStatuses = () => [
  ...
  const calculatePasswordStrength = (password: string) => {
    ...
    if (score < 60) {
      return { strength: score, label: t`Fair`, color: "orange", percentage: score };
    }
    if (score < 80) {
      return { strength: score, label: t`Good`, color: "yellow", percentage: score };
    }
    return { strength: score, label: t`Strong`, color: "green", percentage: score };
  };
