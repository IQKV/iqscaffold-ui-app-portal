                                    ...
                                    <Stack gap="xs">
                                        <Group grow>
                                            <TextInput
                                                ...
                                                onChange={(e) => setEditStage({ ...editStage, name: e.currentTarget.value })}
                                                required
                                            />
                                            <Select
                                                label={t`Type`}
                                        ...
                                        <Group gap="xs">
                                            <Tooltip label={t`Move Up`}>
                                                <ActionIcon
                                                    variant="subtle"
                                                    disabled={index === 0}
                                                    onClick={() => handleReorder(stage.id, stage.orderIndex, "up")}
                                                >
                                                    <IconArrowUp size={16} />
                                                </ActionIcon>
                                            </Tooltip>
                                            <Tooltip label={t`Move Down`}>
                                                <ActionIcon
                                                    ...
                                                    onClick={() => handleReorder(stage.id, stage.orderIndex, "down")}
                                                >
